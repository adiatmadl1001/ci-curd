...
<body>
    <header class="flex space-x-2 items-center bg-blue-600 p-4">
        ...
        <h1 class="text-white text-xl font-bold">Update Employee</h1>
    </header>
    <div class="flex">
        <div class="w-1/2">
            <div class="container mx-10 mt-7">
                ...
                <form action="<?= base_url('employees/update'. $employees['id']); ?>" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" id="email" name="email" value="<?= $employees['email']; ?>" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required >
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="address" name="address" value="<?= $employees['address']; ?>" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required >
                    </div>
